...
public class UpUsers extends javax.swing.JPanel {
    ...
    public UpUsers(String usid, String usname, String usap1, String usap2, String usdom, String ustel, String usClav) {
        initComponents();
        conn = new Connect();
        reg = conn.getConnection();
        idus = usid;
    ...
    private void initComponents() {
        ...
        javax.swing.JTextField tel = new javax.swing.JTextField();
        ...
        add(Clave, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 360, 260, 30));
        ...
        add(button, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 340, 260, 50));
        ...
        add(Text6, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 150, -1, -1));

        tel1.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        tel1.setForeground(new java.awt.Color(102, 102, 102));
        tel1.setText("Ingrese su telefono");
        tel1.setBorder(null);
        tel1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                tel1MousePressed(evt);
            }
        });
        tel1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tel1ClavActionPerformed(evt);
            }
        });
        add(tel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 280, 260, 30));
    ...
    private void domMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_domMousePressed
       ...
       if(dom.getText().equals("Ingrese el domicilio"))
        dom.setText("");
       if(Clave.getText().equals("") || Clave.getText() == null || Clave.getText().equals(" "))
        Clave.setText("Ingrese clave");
       
          if(tel1.getText().equals("") || tel1.getText() == null || tel1.getText().equals(" "))
        tel1.setText("Ingrese un número telefónico");    
    ...
    private void ClaveMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ClaveMousePressed
       ...
       if(dom.getText().equals("") || dom.getText() == null || dom.getText().equals(" "))
        dom.setText("Ingrese el domicilio");
       if(tel1.getText().equals("Ingrese un número telefónico"))
        tel1.setText("");
    ...
    private void buttonMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buttonMousePressed
        if(name.getText().equals("Ingrese el nombre") || ap1.getText().equals("Ingrese el apellido paterno")
            || ap2.getText().equals("Ingrese el apellido materno") || dom.getText().equals("Ingrese el domicilio")
             || Clave.getText().equals("Ingrese Clave") || tel1.getText().equals("Ingrese su telefono")){
        ...
        else
        {
            ...
            String utel = tel1.getText();
            String uClave = Clave.getText();

            if(uname == null || "".equals(uname) || uapp == null || "".equals(uapp) || uapm == null || "".equals(uapm) || udom == null || "".equals(udom) || utel == null || "".equals(utel)|| "".equals(uClave)){
                javax.swing.JOptionPane.showMessageDialog(this, "Debe llenar todos los campos \n", "AVISO", javax.swing.JOptionPane.INFORMATION_MESSAGE);
                name.requestFocus();
            }
            else{ 
                try {
                    if(edit)
                        EditUser(idus, uname, uapp, uapm, udom, utel, uClave);
                    else
                        InsertUser(uname, uapp, uapm, udom, utel, uClave);
    ...
    private void tel1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tel1MousePressed
        // TODO add your handling code here:
    }//GEN-LAST:event_tel1MousePressed

    private void tel1ClavActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tel1ClavActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_tel1ClavActionPerformed
    ...
    public void InsertUser(String name, String app, String apm, String dom, String tel, String Clave) throws SQLException{
        Statement stm = reg.createStatement();
        
        stm.executeUpdate("INSERT INTO `users` (`name`, `last_name_p`, `last_name_m`, `domicilio`, `tel`, `Clave`) VALUES ('"+name+"', '"+app+"', '"+ apm +"', '"+ dom +"', '"+tel+", '"+ Clave +"')");
        javax.swing.JOptionPane.showMessageDialog(this, "¡Usuario registrado correctamente! \n", "HECHO", javax.swing.JOptionPane.INFORMATION_MESSAGE);
        
    }
    
    public void EditUser(String id, String name, String app, String apm, String dom, String tel, String Clave) throws SQLException{
        Statement stm = reg.createStatement();
        
        stm.executeUpdate("UPDATE `users` SET `name` = '"+name+"', `last_name_p` = '"+app+"', `last_name_m` = '"+apm+"', `domicilio` = '"+dom+"', `tel` = '"+tel+"', `Clave` = '"+Clave+"' WHERE `id` = "+ id +";");
